...
{
    public class OrderconsumerController : BackgroundService
    {
        private readonly ILogger _logger;
        private IConnection _connection;
        private IModel _channel;

        public OrderconsumerController(ILoggerFactory loggerFactory)
        {
            this._logger = loggerFactory.CreateLogger<OrderconsumerController>();
            InitRabbitMQ();
        }
